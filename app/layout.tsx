...
export default function RootLayout({
  ...
  <meta
    content="At poptical sunwear, we're reshaping the way businesses connect."
    name="description" 
  />
  <meta content="poptical sunwear" name="keywords" property="poptical sunwearbynature, poptical sunwear, men, women" />
  <meta
    content="poptical sunwear"
    name=""
    property="og:title"
  />
  <meta
    content="https://poptical sunwearbynature.com/"
    name=""
    property="og:url"
  />
